...
from .general_inout import LoggerPerso
import logging
class Daq970a(InOut,General,LoggerPerso):
    ...
    def get_measure_over_time(self,  measurement_type,volt_type=None,amp_type=None,range_measure="DEFAULT",resolution_measure="DEFAULT",trigger_delay=0.2,count=100,timeout=1000):
        # More Generalisation !
